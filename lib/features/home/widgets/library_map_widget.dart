            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  ...
                  ...List.generate(columns + 3, (i) => Positioned(
                    left: i * cellSize,
                    top: 0,
                    bottom: 0,
                    child: VerticalDivider(color: Colors.black.withValues(alpha: 0.03), width: 1),
                  )),
                  ...
                  ...tables.map((table) {
                    ...
                    return Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () => onTableTap(table.id, table.isFull),
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 300),
                          width: cellSize * 0.8,
                          height: cellSize * 0.8,
                          decoration: BoxDecoration(
                            color: table.isFull ? AppColors.error : AppColors.success,
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (table.hasSocket)
                                  const Icon(Icons.power, color: Colors.white, size: 10),
                              ],
                            ),
                          ),
                        ),
